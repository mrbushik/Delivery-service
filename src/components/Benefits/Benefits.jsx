    ...
    <section>
      <div className="container">
        ...
        <p className="benefits-description">
          Будем знакомы — Владислав Каткаев, основатель курьерской службы Dostaver, лично
          контролирую работу курьеров.
        </p>
        <div className="benefit-rounds-wrapper">
          ...
          <div className={classNames('benefit-round', 'benefit-round__person')}></div>
          <div className="benefit-round">
          ...
          <div className="benefit-round">
            ...
            <p className="benefit-round__subtitle">
              клиентов из YouDo оценили мою работу на 5 по статистике за 3 года работы — с 2019 по
              2021
            </p>
            <img src={Reviews} />
            <a href="##" className="benefit-round__link">
              Посмотреть профиль
            </a>
          </div>
        </div>
