    ...
    <section>
        <div className="container">
            ...
            <div className="processes-decription">
                ...
                <p>Каждый курьер имеет при себе мобильный <b>терминал aQsi 5</b> со встроенным эквайрингом.</p>
                <p>Ваши клиенты могут по факту оплачивать заказ картой <br/>и получать бумажный кассовый чек. </p>
            </div>
